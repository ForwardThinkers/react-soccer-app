    ...
    <div className="match_block">
      ...
      <div className="match_wrapper">
        ...
        <div className="match_top">
          <div className="left">
            <div className="icon" style={{ background: `url(images/team_icons/${match.localThmb}.png) no-repeat` }}></div>
        ...
        <div className="match_bottom">
          <div className="left">
            <div className="icon" style={{ background: `url(images/team_icons/${match.awayThmb}.png) no-repeat` }}></div>
